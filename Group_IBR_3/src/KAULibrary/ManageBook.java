...
//        }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        Book book = new Book();
        try {
            boolean isAdded = book.addBook(Integer.parseInt(isbnTextField.getText()), titleTextField.getText(), authorTextField.getText(), classficationCombo.getSelectedItem().toString(), Integer.parseInt(availabilityField.getText()));
            errorLabel.setVisible(false);
            if (isAdded) {
  ...
  Book book = new Book();
        try {
            ...
            boolean isAdded = book.updateBook(titleTextField.getText(), Integer.parseInt(isbnTextField.getText()), authorTextField.getText(), classficationCombo.getSelectedItem().toString(), Integer.parseInt(availabilityField.getText()), book.getISBN());
            errorLabel.setVisible(false);
            if (isAdded) {
                JOptionPane.showMessageDialog(null, "The Book is Updated Successfully");
            } else {
                JOptionPane.showMessageDialog(null, "The Book is updated Unsuccessfully");
            }
            if (isbnTextField.getText().equals(" ") || titleTextField.getText().equals(" ") || authorTextField.getText().equals(" ") || availabilityField.getText().equals(" ")) {
                errorLabel2.setVisible(true);
                errorLabel2.setText("Please fill all the fields");
