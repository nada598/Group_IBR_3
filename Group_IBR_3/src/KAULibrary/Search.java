...
public class Search extends javax.swing.JFrame {
    ...
    public Search() {
        ...
        DataBase.populateTabel(jTable1);
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        book = new Book();
        book.search(searchTypeTextField.getText(), searchComboBox.getSelectedIndex());
        //titleTextField.setText("did it  ");
    }//GEN-LAST:event_searchActionPerformed

    private void detailsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detailsButtonActionPerformed
        book = new Book();
        book.setBookTitle(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        book.deleteBook(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
    ...
    private javax.swing.JTextField searchTypeTextField;
    private javax.swing.JButton updateBook;
    // End of variables declaration//GEN-END:variables

    public void searchResult(ResultSet res) throws SQLException {
        while (res.next()) {
