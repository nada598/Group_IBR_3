...
public class BookInfo extends javax.swing.JFrame {
    ...
    private void borrowButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrowButtonActionPerformed
      if ( DataBase.issueBook(id, book.getBookTitle()).equalsIgnoreCase("")){
          // successful
      } else if (DataBase.issueBook(id, book.getBookTitle()).equalsIgnoreCase("availability")){
          // error book not avaliable
       } else if (DataBase.issueBook(id, book.getBookTitle()).equalsIgnoreCase("history")){
           // user limit 
       }
